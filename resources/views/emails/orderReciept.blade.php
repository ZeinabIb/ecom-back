					...
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
                                ...
                                <tr class="table_row">
                                    <td class="column-1">{{ $productInCart->name }}</td>
                                    <td class="column-2">$ {{ $productInCart->price }}</td>
                                    <td class="column-3">{{ $productInCart->pivot->quantity }}</td> <!-- Accessing the quantity from pivot table -->
                                    <td class="column-4">$ {{ number_format($productInCart->price * $productInCart->pivot->quantity, 2) }}</td>
                                </tr>
